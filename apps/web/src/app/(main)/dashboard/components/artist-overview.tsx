...
function ArtistOverviewSkeleton() {
  return (
    <div data-testid="artist-overview-skeleton" className="space-y-6">
      <Card>
        <CardHeader>
...
export function ArtistOverview() {
  ...
  if (loading) return <ArtistOverviewSkeleton />

  if (error) {
    return (
      <div data-testid="artist-overview-error" className="text-center py-8">
  ...
  return (
    <div data-testid="artist-overview" className="space-y-6">
      {/* Profile completion */}
